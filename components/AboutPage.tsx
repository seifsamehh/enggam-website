...
const AboutPage = () => {
  ...
  return (
    <section className="min-h-screen overflow-hidden about-page">
      <div className="hero min-h-[70vh] flex justify-center items-center relative">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="icon icon-tabler icon-tabler-circle-arrow-left cursor-pointer absolute top-4 left-8"
          onClick={goBack}
          width="44"
          height="44"
          viewBox="0 0 24 24"
      ...
      <div className="relative flex items-center justify-center min-h-[60vh] gap-12 about-content min-[290px]:flex-wrap md:flex-nowrap min-[290px]:p-4 md:p-0">
        ...
        <div className="right">
          <p className="max-w-2xl text-xl leading-8 min-[290px]:text-center md:text-left">
            Gift Card Company located in Egypt. we sell all prepaid cards like:-
            ...
            fast. A single integration unlocks global & local alternative
            payment methods - Cards, Online Banking, Bank Transfer, Cash,
            E-wallets, Vouchers & Carrier Billing.
          </p>
        </div>
        ...
        <div className="left">
          <div className="grid min-[290px]:grid-cols-1 md:grid-cols-2 grid-rows-3 gap-4">
            <div className="box">
              ...
              <div className="box-content">
                ...
                <p>
                  ...
                  development to reach the best things, and the site will
            ...
            <div className="box">
              ...
              <div className="box-content">
                <h3 className={`${raleway.className} text-2xl`}>Fast Order</h3>
                <p>
                  The order can be made at any time and delivered as quickly as
                  possible by selecting the card and it will be sent to you via
                  email.
                </p>
              </div>
            </div>
            ...
            <div className="box">
              ...
              <div className="box-content">
                ...
                <p>
                  someone can that possesses a complete set of ways to purchase
                  any thing on your Website easily.
                </p>
              </div>
            </div>
          </div>
