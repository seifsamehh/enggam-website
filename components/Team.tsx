...
export default function Team() {
  return (
    <section className="team overflow-hidden" id="team">
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-xl">
          <h3 className={`${raleway.className} text-8xl text-[#0056b3]`}>
            Meet our <span className="text-[#ff474d]">talent team</span>
          </h3>
        </div>
        <div className="team-boxs my-12 flex justify-start items-center gap-12 flex-wrap">
          {/* ali */}
          <div className="team-box md:w-2/5 flex justify-center items-start gap-4 min-[290px]:flex-wrap md:flex-nowrap">
            <div className="image">
              <Image
                src="/ali.webp"
                alt="ali"
            ...
            <div className="content">
              <h4 className="text-lg text-gray-700 font-semibold">Ali Nasr</h4>
              <p className="text-indigo-600">CEO of ENGGAM</p>
              <p className="text-gray-600 mt-2 max-w-2xl">
                Ali Nasr leads enggam, a trailblazing company revolutionizing
                how we access and spend digitally. With a knack for innovation
                and an eye on convenience, he has made enggam the go-to platform
                for game cards, gift cards, and instant payment solutions.
              </p>
              <div className="social-links flex gap-4 mt-6">
                {/* github */}
                <Link href="https://github.com/mannoo123" target="_blank">
                  <svg
                ...
                {/* linkedin */}
                <Link
                  href="https://www.linkedin.com/in/ali-nasr-28a854219/"
                  target="_blank"
                >
                  <svg
                    className="w-5 h-5 duration-150 hover:text-gray-500"
          ...
          {/* ola */}
          <div className="team-box flex justify-center items-center gap-4 min-[290px]:flex-wrap md:flex-nowrap">
            <div className="image">
              <Image
            ...
            <div className="content">
              <h4 className="text-lg text-gray-700 font-semibold">Ola Nasr</h4>
              <p className="text-indigo-600">
                Motion Graphic Designer And Web Management
              </p>
              <p className="text-gray-600 mt-2 max-w-2xll">
                Ola Nasr plays a key role in shaping enggam's brand through
                stunning motion graphics and web management. Contribute to our
                rapid growth and make a lasting impact on how millions
                experience digital cards.
              </p>
            </div>
          </div>
        </div>
